...
function BarChats() {
  ...
  return (
    <div className='barcharts'>
      <h1>Bar-Chats - Winning team</h1>
        <div>
        <ResponsiveContainer width="50%" aspect={3} >
            <BarChart data={Array} width={900} hegigh={400} margin={{top : 5  }} >
                <XAxis dataKey="team1" />
                <YAxis/>
                <Tooltip/>
                <Bar dataKey="win_by_runs" fill="red" stroke="#8884d8"/>
            </BarChart>

        </ResponsiveContainer>
        </div>
        <div>
        <h1>Bar-Chats - Player Of the Match</h1>
        <ResponsiveContainer width="50%" aspect={3} >
            <BarChart data={Array} width={900} hegigh={400}>
                <XAxis dataKey="player_of_match"/>
                <YAxis/>
                <Tooltip/>
                <Bar dataKey="win_by_wickets" fill="green"/>
            </BarChart>
