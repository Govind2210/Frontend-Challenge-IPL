...
import {ResponsiveContainer , ScatterChart  , Scatter ,Tooltip , Bar , XAxis ,YAxis} from 'recharts'
...
function ScatterPlot() {
  return (
    <div>
        <h1>Scatter Plot - Win by Wicket </h1>
        <ResponsiveContainer width="50%" aspect={3} >
            <ScatterChart data={Array} width={900} hegigh={400}>
                <XAxis dataKey="season"/>
                <YAxis dataKey="win_by_runs"/>
                <Tooltip/>
                <Scatter  fill="blue"/>
            </ScatterChart>
        </ResponsiveContainer>
